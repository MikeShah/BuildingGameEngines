...
void main()
{
  ...
  // Create our Sound
  Sound mySound1 = Sound("./assets/sounds/collide.wav");
  Sound mySound2 = Sound("./assets/sounds/whoosh.wav");
  Sound mySound3 = Sound("./assets/sounds/flowlab.wav");
  ...
  while(gameIsRunning){
    ...
    while(SDL_PollEvent(&event)){
      ...
      if(event.type == SDL_EVENT_KEY_DOWN){
        mySound1.ResumeSound();
        mySound1.PlaySound(false);
      }
      if(event.type == SDL_EVENT_KEY_UP){
        mySound2.ResumeSound();
        mySound2.PlaySound(false);
      }
    }

    mySound3.ResumeSound();
    mySound3.PlaySound(true);
